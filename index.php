 ...
 *
 * This is the game itself. The public entrance is index.php (the
 * gate); a browser only lands here after api/auth.php has accepted
 * the password and marked the session unlocked.
 */
